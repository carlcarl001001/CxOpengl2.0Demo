package com.example.carl.cxopengl20demo.sample5_1;
...
import com.example.carl.cxopengl20demo.sample5_1.MatrixState;
import com.example.carl.cxopengl20demo.sample5_1.SixPointedStar;
...
class MySurfaceView extends GLSurfaceView
{
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            {
                ha[i]=new SixPointedStar(MySurfaceView.this,0.2f,0.5f,-1.0f*i);
            }
            //打开深度检测
